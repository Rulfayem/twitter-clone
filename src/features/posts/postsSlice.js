...
export const updatePost = createAsyncThunk(
    ...
    async ({ userId, postId, newPostContent, newFile }) => {
        try {
            //upload the new file to the storage if it exists and get it's URL
            let newImageUrl;
            if (newFile) {
            ...
            if (postSnap.exists()) {
                ...
                const updatedData = {
                    ...postData, content: newPostContent || postData.content, imageUrl: newImageUrl || postData.imageUrl,
                };
...
//slice, idk what this is exactly
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(deletePost.fulfilled, (state, action) => {
                ...
                //filters out the deleted posts from state
